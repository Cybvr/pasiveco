...
function FeedbackSurveyPageContent() {
                  ...
                  {SATISFACTION_OPTIONS.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-xl border px-4 py-3 text-left text-sm transition-colors ${selected
...
export default function FeedbackSurveyPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-background px-4 py-12 sm:px-6 lg:px-8" />}>
      <FeedbackSurveyPageContent />
    </Suspense>
  )
}
