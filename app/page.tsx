        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative aspect-video sm:aspect-square lg:aspect-auto h-[400px] lg:h-auto">
            ...
            <div className="absolute top-0 left-0 w-2/3 aspect-[4/5] bg-muted/20 overflow-hidden shadow-2xl z-20 group hover:scale-[1.02] transition-transform duration-700 rounded-none">
              ...
              <div className="absolute bottom-4 left-4 rounded-none bg-background/80 px-2 py-1 text-xs font-mono uppercase text-foreground backdrop-blur">Digital Art</div>
            </div>
            <div className="absolute bottom-0 right-0 w-1/2 aspect-square bg-muted/20 overflow-hidden shadow-2xl z-30 group hover:scale-[1.05] transition-transform duration-700 rounded-none">
              ...
              <div className="absolute bottom-4 left-4 rounded-none bg-background/80 px-2 py-1 text-xs font-mono uppercase text-foreground backdrop-blur">Audio</div>
            </div>
            <div className="absolute top-1/4 right-0 w-1/3 aspect-[3/4] bg-muted/20 overflow-hidden shadow-xl z-10 group hover:scale-[1.02] transition-transform duration-700 rounded-none">
              ...
              <div className="absolute bottom-4 left-4 rounded-none bg-background/80 px-2 py-1 text-xs font-mono uppercase text-foreground backdrop-blur">Lifestyle</div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-10 order-2 lg:order-1">
              <div className="inline-block rounded-none border border-border px-3 py-1 text-[10px] uppercase tracking-widest text-muted-foreground">
                Your Space Hub
              </div>
