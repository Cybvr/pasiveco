    ...
    <div className="space-y-2">
      ...
      <section className="px-1 grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Link
          ...
          className="rounded-2xl border border-primary/15 bg-primary/[0.06] p-5 text-foreground transition-colors hover:bg-primary/[0.1] sm:p-6"
        >
          <div>
            <p className="mb-1.5 text-[11px] font-medium uppercase tracking-widest text-muted-foreground">Earnings Balance</p>
            <p className="text-2xl font-bold text-foreground sm:text-2xl">{formatCurrency(earningsSummary.availableBalance, currency)}</p>
          </div>
          <div className="mt-6">
            <span className="inline-flex rounded-full bg-primary/10 px-3 py-1 text-[11px] font-semibold whitespace-nowrap text-primary sm:text-xs">
              View earnings
            </span>
          </div>
        </Link>
