...
export default async function EarningDetailPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      {transaction ? (
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground">
            This ID does not match any earning transaction in the current mock data.
          </CardContent>
        </Card>
      )}
    </div>
